    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ManyToManyField(null=True, to='core.OrderItem')),
                ('corporateUser', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='corporate.ContactModel')),
                ('orders', models.ManyToManyField(null=True, to='core.Order')),
        ...
        migrations.AddField(
            model_name='item',
            name='feedback',
            field=models.ManyToManyField(blank=True, default='review', null=True, to='core.Review'),
        ),
    ]
